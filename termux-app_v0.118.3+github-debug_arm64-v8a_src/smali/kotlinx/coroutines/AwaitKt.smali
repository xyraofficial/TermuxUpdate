...
.method public static final joinAll(Ljava/util/Collection;Lkotlin/coroutines/Continuation;)Ljava/lang/Object;
    ...
    iget-object v4, p1, Lkotlinx/coroutines/AwaitKt$joinAll$3;->L$0:Ljava/lang/Object;
    ...
    iput-object v4, p1, Lkotlinx/coroutines/AwaitKt$joinAll$3;->L$0:Ljava/lang/Object;

    const/4 v8, 0x1

    iput v8, p1, Lkotlinx/coroutines/AwaitKt$joinAll$3;->label:I

    invoke-interface {v6, p1}, Lkotlinx/coroutines/Job;->join(Lkotlin/coroutines/Continuation;)Ljava/lang/Object;
    ...
    .end local p0    # "$this$joinAll":Ljava/util/Collection;
    if-ne v2, v1, :cond_1
    ...
    .restart local p0    # "$this$joinAll":Ljava/util/Collection;
    :goto_2
    goto :goto_1
...
.method public static final joinAll([Lkotlinx/coroutines/Job;Lkotlin/coroutines/Continuation;)Ljava/lang/Object;
    ...
    iget v5, p1, Lkotlinx/coroutines/AwaitKt$joinAll$1;->I$1:I

    iget v6, p1, Lkotlinx/coroutines/AwaitKt$joinAll$1;->I$0:I
    ...
    .local p0, "jobs":[Lkotlinx/coroutines/Job;
    move-object v2, p0
    ...
    .local v9, "it":Lkotlinx/coroutines/Job;
    const/4 v10, 0x0

    .line 54
    .local v10, "$i$a$-forEach-AwaitKt$joinAll$2":I
    iput-object v7, p1, Lkotlinx/coroutines/AwaitKt$joinAll$1;->L$0:Ljava/lang/Object;

    iput v6, p1, Lkotlinx/coroutines/AwaitKt$joinAll$1;->I$0:I

    iput v4, p1, Lkotlinx/coroutines/AwaitKt$joinAll$1;->I$1:I

    iput v3, p1, Lkotlinx/coroutines/AwaitKt$joinAll$1;->label:I

    invoke-interface {v9, p1}, Lkotlinx/coroutines/Job;->join(Lkotlin/coroutines/Continuation;)Ljava/lang/Object;

    move-result-object v2

    .end local v2    # "element$iv":Ljava/lang/Object;
    .end local v8    # "$this$forEach$iv":[Ljava/lang/Object;
    .end local v9    # "it":Lkotlinx/coroutines/Job;
    .end local p0    # "jobs":[Lkotlinx/coroutines/Job;
    if-ne v2, v1, :cond_1
    ...
    .end local v10    # "$i$a$-forEach-AwaitKt$joinAll$2":I
    .restart local v4    # "$i$f$forEach":I
    :goto_2
    add-int/lit8 v2, v5, 0x1

    .restart local p0    # "jobs":[Lkotlinx/coroutines/Job;
    move v5, v4
