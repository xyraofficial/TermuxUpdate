...
.method private static final Path(Ljava/lang/String;)Ljava/nio/file/Path;
    ...
    const-string v2, "Paths.get(path)"
...
.method private static final varargs Path(Ljava/lang/String;[Ljava/lang/String;)Ljava/nio/file/Path;
    ...
    const-string v2, "Paths.get(base, *subpaths)"
...
.method private static final absolute(Ljava/nio/file/Path;)Ljava/nio/file/Path;
    ...
    .line 94
    .local v0, "$i$f$absolute":I
    invoke-interface {p0}, Ljava/nio/file/Path;->toAbsolutePath()Ljava/nio/file/Path;

    move-result-object v1

    const-string v2, "toAbsolutePath()"
...
.method private static final absolutePathString(Ljava/nio/file/Path;)Ljava/lang/String;
    ...
    .line 108
    .local v0, "$i$f$absolutePathString":I
    invoke-interface {p0}, Ljava/nio/file/Path;->toAbsolutePath()Ljava/nio/file/Path;
...
.method private static final copyTo(Ljava/nio/file/Path;Ljava/nio/file/Path;Z)Ljava/nio/file/Path;
    ...
    invoke-static {p0, p1, v2}, Ljava/nio/file/Files;->copy(Ljava/nio/file/Path;Ljava/nio/file/Path;[Ljava/nio/file/CopyOption;)Ljava/nio/file/Path;

    move-result-object v2

    const-string v3, "Files.copy(this, target, *options)"
...
.method private static final varargs copyTo(Ljava/nio/file/Path;Ljava/nio/file/Path;[Ljava/nio/file/CopyOption;)Ljava/nio/file/Path;
    ...
    const-string v2, "Files.copy(this, target, *options)"
...
.method static synthetic copyTo$default(Ljava/nio/file/Path;Ljava/nio/file/Path;ZILjava/lang/Object;)Ljava/nio/file/Path;
    ...
    :cond_1
    new-array v0, p4, [Ljava/nio/file/CopyOption;
    ...
    const-string v1, "Files.copy(this, target, *options)"
...
.method private static final varargs createDirectories(Ljava/nio/file/Path;[Ljava/nio/file/attribute/FileAttribute;)Ljava/nio/file/Path;
    ...
    .line 529
    .local v0, "$i$f$createDirectories":I
    array-length v1, p1
    ...
    const-string v2, "Files.createDirectories(this, *attributes)"
...
.method private static final varargs createDirectory(Ljava/nio/file/Path;[Ljava/nio/file/attribute/FileAttribute;)Ljava/nio/file/Path;
    ...
    .line 507
    .local v0, "$i$f$createDirectory":I
    array-length v1, p1
    ...
    invoke-static {p0, v1}, Ljava/nio/file/Files;->createDirectory(Ljava/nio/file/Path;[Ljava/nio/file/attribute/FileAttribute;)Ljava/nio/file/Path;

    move-result-object v1

    const-string v2, "Files.createDirectory(this, *attributes)"
...
.method private static final varargs createFile(Ljava/nio/file/Path;[Ljava/nio/file/attribute/FileAttribute;)Ljava/nio/file/Path;
    ...
    const-string v2, "Files.createFile(this, *attributes)"
...
.method private static final varargs createSymbolicLinkPointingTo(Ljava/nio/file/Path;Ljava/nio/file/Path;[Ljava/nio/file/attribute/FileAttribute;)Ljava/nio/file/Path;
    ...
    .line 824
    .local v0, "$i$f$createSymbolicLinkPointingTo":I
    array-length v1, p2
    ...
    invoke-static {p0, p1, v1}, Ljava/nio/file/Files;->createSymbolicLink(Ljava/nio/file/Path;Ljava/nio/file/Path;[Ljava/nio/file/attribute/FileAttribute;)Ljava/nio/file/Path;

    move-result-object v1

    const-string v2, "Files.createSymbolicLink\u2026his, target, *attributes)"
...
.method private static final varargs createTempDirectory(Ljava/lang/String;[Ljava/nio/file/attribute/FileAttribute;)Ljava/nio/file/Path;
    ...
    .line 919
    .local v0, "$i$f$createTempDirectory":I
    array-length v1, p1
    ...
    invoke-static {p0, v1}, Ljava/nio/file/Files;->createTempDirectory(Ljava/lang/String;[Ljava/nio/file/attribute/FileAttribute;)Ljava/nio/file/Path;

    move-result-object v1

    const-string v2, "Files.createTempDirectory(prefix, *attributes)"
...
.method public static final varargs createTempDirectory(Ljava/nio/file/Path;Ljava/lang/String;[Ljava/nio/file/attribute/FileAttribute;)Ljava/nio/file/Path;
    ...
    const-string v1, "Files.createTempDirector\u2026ory, prefix, *attributes)"
    ...
    const-string v1, "Files.createTempDirectory(prefix, *attributes)"
...
.method static synthetic createTempDirectory$default(Ljava/lang/String;[Ljava/nio/file/attribute/FileAttribute;ILjava/lang/Object;)Ljava/nio/file/Path;
    ...
    .line 919
    .local p2, "$i$f$createTempDirectory":I
    array-length p3, p1
    ...
    invoke-static {p0, p3}, Ljava/nio/file/Files;->createTempDirectory(Ljava/lang/String;[Ljava/nio/file/attribute/FileAttribute;)Ljava/nio/file/Path;

    move-result-object p3

    const-string v0, "Files.createTempDirectory(prefix, *attributes)"
...
.method private static final varargs createTempFile(Ljava/lang/String;Ljava/lang/String;[Ljava/nio/file/attribute/FileAttribute;)Ljava/nio/file/Path;
    ...
    invoke-static {p0, p1, v1}, Ljava/nio/file/Files;->createTempFile(Ljava/lang/String;Ljava/lang/String;[Ljava/nio/file/attribute/FileAttribute;)Ljava/nio/file/Path;

    move-result-object v1

    const-string v2, "Files.createTempFile(prefix, suffix, *attributes)"
...
.method public static final varargs createTempFile(Ljava/nio/file/Path;Ljava/lang/String;Ljava/lang/String;[Ljava/nio/file/attribute/FileAttribute;)Ljava/nio/file/Path;
    ...
    const-string v1, "Files.createTempFile(dir\u2026fix, suffix, *attributes)"
    ...
    const-string v1, "Files.createTempFile(prefix, suffix, *attributes)"
...
.method static synthetic createTempFile$default(Ljava/lang/String;Ljava/lang/String;[Ljava/nio/file/attribute/FileAttribute;ILjava/lang/Object;)Ljava/nio/file/Path;
    ...
    invoke-static {p0, p1, p4}, Ljava/nio/file/Files;->createTempFile(Ljava/lang/String;Ljava/lang/String;[Ljava/nio/file/attribute/FileAttribute;)Ljava/nio/file/Path;

    move-result-object p4

    const-string v0, "Files.createTempFile(prefix, suffix, *attributes)"
...
.method private static final div(Ljava/nio/file/Path;Ljava/lang/String;)Ljava/nio/file/Path;
    ...
    const-string v2, "this.resolve(other)"
...
.method private static final varargs synthetic fileAttributesView(Ljava/nio/file/Path;[Ljava/nio/file/LinkOption;)Ljava/nio/file/attribute/FileAttributeView;
    ...
    .line 660
    .local v0, "$i$f$fileAttributesView":I
    const/4 v1, 0x4
    ...
    const-class v3, Ljava/nio/file/attribute/FileAttributeView;
    ...
    const-class v1, Ljava/nio/file/attribute/FileAttributeView;

    invoke-static {p0, v1}, Lkotlin/io/path/PathsKt;->fileAttributeViewNotAvailable(Ljava/nio/file/Path;Ljava/lang/Class;)Ljava/lang/Void;
...
.method private static final varargs synthetic fileAttributesViewOrNull(Ljava/nio/file/Path;[Ljava/nio/file/LinkOption;)Ljava/nio/file/attribute/FileAttributeView;
    ...
    .line 644
    .local v0, "$i$f$fileAttributesViewOrNull":I
    const/4 v1, 0x4
...
.method private static final forEachDirectoryEntry(Ljava/nio/file/Path;Ljava/lang/String;Lkotlin/jvm/functions/Function1;)V
    ...
    .line 438
    .local v0, "$i$f$forEachDirectoryEntry":I
    ...
    .line 1000
    .local v5, "it":Ljava/nio/file/DirectoryStream;
    const/4 v6, 0x0

    .line 438
    .local v6, "$i$a$-use-PathsKt__PathUtilsKt$forEachDirectoryEntry$1":I
    const-string v7, "it"
    ...
    .end local v5    # "it":Ljava/nio/file/DirectoryStream;
    .end local v6    # "$i$a$-use-PathsKt__PathUtilsKt$forEachDirectoryEntry$1":I
    ...
    .end local v0    # "$i$f$forEachDirectoryEntry":I
    ...
    .restart local v0    # "$i$f$forEachDirectoryEntry":I
...
.method static synthetic forEachDirectoryEntry$default(Ljava/nio/file/Path;Ljava/lang/String;Lkotlin/jvm/functions/Function1;ILjava/lang/Object;)V
    ...
    .line 438
    .local p3, "$i$f$forEachDirectoryEntry":I
    invoke-static {p0, p1}, Ljava/nio/file/Files;->newDirectoryStream(Ljava/nio/file/Path;Ljava/lang/String;)Ljava/nio/file/DirectoryStream;
    ...
    .end local p1    # "glob":Ljava/lang/String;
    .end local p2    # "action":Lkotlin/jvm/functions/Function1;
    .end local p3    # "$i$f$forEachDirectoryEntry":I
    :try_start_1
    throw v1
    :try_end_1
    .catchall {:try_start_1 .. :try_end_1} :catchall_1
    ...
    .restart local p1    # "glob":Ljava/lang/String;
    .restart local p2    # "action":Lkotlin/jvm/functions/Function1;
    .restart local p3    # "$i$f$forEachDirectoryEntry":I
    :catchall_1
    move-exception v3
...
.method private static final varargs getAttribute(Ljava/nio/file/Path;Ljava/lang/String;[Ljava/nio/file/LinkOption;)Ljava/lang/Object;
    ...
    invoke-static {p0, p1, v1}, Ljava/nio/file/Files;->getAttribute(Ljava/nio/file/Path;Ljava/lang/String;[Ljava/nio/file/LinkOption;)Ljava/lang/Object;
...
.method private static final getInvariantSeparatorsPath(Ljava/nio/file/Path;)Ljava/lang/String;
    ...
    .line 79
    .local v0, "$i$f$getInvariantSeparatorsPath":I
...
.method private static final varargs getLastModifiedTime(Ljava/nio/file/Path;[Ljava/nio/file/LinkOption;)Ljava/nio/file/attribute/FileTime;
    ...
    .line 715
    .local v0, "$i$f$getLastModifiedTime":I
    array-length v1, p1
    ...
    const-string v2, "Files.getLastModifiedTime(this, *options)"
...
.method private static final varargs getOwner(Ljava/nio/file/Path;[Ljava/nio/file/LinkOption;)Ljava/nio/file/attribute/UserPrincipal;
    ...
    invoke-static {p0, v1}, Ljava/nio/file/Files;->getOwner(Ljava/nio/file/Path;[Ljava/nio/file/LinkOption;)Ljava/nio/file/attribute/UserPrincipal;
...
.method private static final varargs getPosixFilePermissions(Ljava/nio/file/Path;[Ljava/nio/file/LinkOption;)Ljava/util/Set;
    ...
    .line 771
    .local v0, "$i$f$getPosixFilePermissions":I
    array-length v1, p1
    ...
    const-string v2, "Files.getPosixFilePermissions(this, *options)"
...
.method public static final listDirectoryEntries(Ljava/nio/file/Path;Ljava/lang/String;)Ljava/util/List;
    ...
    .line 398
    .local v3, "$i$a$-use-PathsKt__PathUtilsKt$listDirectoryEntries$1":I
    const-string v4, "it"
    ...
    .end local v3    # "$i$a$-use-PathsKt__PathUtilsKt$listDirectoryEntries$1":I
    invoke-static {v0, v1}, Lkotlin/io/CloseableKt;->closeFinally(Ljava/io/Closeable;Ljava/lang/Throwable;)V
...
.method private static final moveTo(Ljava/nio/file/Path;Ljava/nio/file/Path;Z)Ljava/nio/file/Path;
    ...
    const-string v3, "Files.move(this, target, *options)"
...
.method private static final varargs moveTo(Ljava/nio/file/Path;Ljava/nio/file/Path;[Ljava/nio/file/CopyOption;)Ljava/nio/file/Path;
    ...
    const-string v2, "Files.move(this, target, *options)"
...
.method static synthetic moveTo$default(Ljava/nio/file/Path;Ljava/nio/file/Path;ZILjava/lang/Object;)Ljava/nio/file/Path;
    ...
    const-string v1, "Files.move(this, target, *options)"
...
.method private static final varargs synthetic readAttributes(Ljava/nio/file/Path;[Ljava/nio/file/LinkOption;)Ljava/nio/file/attribute/BasicFileAttributes;
    ...
    const-string v2, "Files.readAttributes(thi\u2026 A::class.java, *options)"
...
.method private static final varargs readAttributes(Ljava/nio/file/Path;Ljava/lang/String;[Ljava/nio/file/LinkOption;)Ljava/util/Map;
    ...
    invoke-static {p0, p1, v1}, Ljava/nio/file/Files;->readAttributes(Ljava/nio/file/Path;Ljava/lang/String;[Ljava/nio/file/LinkOption;)Ljava/util/Map;

    move-result-object v1

    const-string v2, "Files.readAttributes(this, attributes, *options)"
...
.method private static final readSymbolicLink(Ljava/nio/file/Path;)Ljava/nio/file/Path;
    ...
    .line 840
    .local v0, "$i$f$readSymbolicLink":I
    invoke-static {p0}, Ljava/nio/file/Files;->readSymbolicLink(Ljava/nio/file/Path;)Ljava/nio/file/Path;

    move-result-object v1

    const-string v2, "Files.readSymbolicLink(this)"
...
.method private static final varargs setAttribute(Ljava/nio/file/Path;Ljava/lang/String;Ljava/lang/Object;[Ljava/nio/file/LinkOption;)Ljava/nio/file/Path;
    ...
    invoke-static {p0, p1, p2, v1}, Ljava/nio/file/Files;->setAttribute(Ljava/nio/file/Path;Ljava/lang/String;Ljava/lang/Object;[Ljava/nio/file/LinkOption;)Ljava/nio/file/Path;

    move-result-object v1

    const-string v2, "Files.setAttribute(this,\u2026tribute, value, *options)"
...
.method private static final setLastModifiedTime(Ljava/nio/file/Path;Ljava/nio/file/attribute/FileTime;)Ljava/nio/file/Path;
    ...
    .line 729
    .local v0, "$i$f$setLastModifiedTime":I
    ...
    const-string v2, "Files.setLastModifiedTime(this, value)"
...
.method private static final setOwner(Ljava/nio/file/Path;Ljava/nio/file/attribute/UserPrincipal;)Ljava/nio/file/Path;
    ...
    const-string v2, "Files.setOwner(this, value)"
...
.method private static final useDirectoryEntries(Ljava/nio/file/Path;Ljava/lang/String;Lkotlin/jvm/functions/Function1;)Ljava/lang/Object;
    ...
    .line 419
    .local v0, "$i$f$useDirectoryEntries":I
    invoke-static {p0, p1}, Ljava/nio/file/Files;->newDirectoryStream(Ljava/nio/file/Path;Ljava/lang/String;)Ljava/nio/file/DirectoryStream;
    ...
    .line 419
    .local v6, "$i$a$-use-PathsKt__PathUtilsKt$useDirectoryEntries$1":I
    const-string v7, "it"
    ...
    .end local v5    # "it":Ljava/nio/file/DirectoryStream;
    .end local v6    # "$i$a$-use-PathsKt__PathUtilsKt$useDirectoryEntries$1":I
    invoke-static {v4}, Lkotlin/jvm/internal/InlineMarker;->finallyStart(I)V
    ...
    .end local v0    # "$i$f$useDirectoryEntries":I
    ...
    .restart local v0    # "$i$f$useDirectoryEntries":I
...
.method static synthetic useDirectoryEntries$default(Ljava/nio/file/Path;Ljava/lang/String;Lkotlin/jvm/functions/Function1;ILjava/lang/Object;)Ljava/lang/Object;
    ...
    .line 419
    .local p3, "$i$f$useDirectoryEntries":I
    invoke-static {p0, p1}, Ljava/nio/file/Files;->newDirectoryStream(Ljava/nio/file/Path;Ljava/lang/String;)Ljava/nio/file/DirectoryStream;
    ...
    .end local p1    # "glob":Ljava/lang/String;
    .end local p2    # "block":Lkotlin/jvm/functions/Function1;
    .end local p3    # "$i$f$useDirectoryEntries":I
    :try_start_1
    throw v1
    :try_end_1
    .catchall {:try_start_1 .. :try_end_1} :catchall_1
    ...
    .restart local p1    # "glob":Ljava/lang/String;
    .restart local p2    # "block":Lkotlin/jvm/functions/Function1;
    .restart local p3    # "$i$f$useDirectoryEntries":I
    :catchall_1
    move-exception v3
