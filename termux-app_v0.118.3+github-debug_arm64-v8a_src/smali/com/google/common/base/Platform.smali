...
.method private static loadPatternCompiler()Lcom/google/common/base/PatternCompiler;
    ...
    .line 75
    .local v0, "loader":Ljava/util/ServiceLoader;, "Ljava/util/ServiceLoader<Lcom/google/common/base/PatternCompiler;>;"
    :try_start_0
    invoke-virtual {v0}, Ljava/util/ServiceLoader;->iterator()Ljava/util/Iterator;

    move-result-object v1

    .local v1, "it":Ljava/util/Iterator;, "Ljava/util/Iterator<Lcom/google/common/base/PatternCompiler;>;"
    :goto_0
    ...
    check-cast v2, Lcom/google/common/base/PatternCompiler;
    :try_end_1
    ...
    :try_start_2
    invoke-static {v2}, Lcom/google/common/base/Platform;->logPatternCompilerError(Ljava/util/ServiceConfigurationError;)V
    :try_end_2
    ...
    .line 84
    .end local v1    # "it":Ljava/util/Iterator;, "Ljava/util/Iterator<Lcom/google/common/base/PatternCompiler;>;"
    :cond_0
    goto :goto_1
    ...
    :goto_1
    new-instance v1, Lcom/google/common/base/Platform$JdkPatternCompiler;

    const/4 v2, 0x0

    invoke-direct {v1, v2}, Lcom/google/common/base/Platform$JdkPatternCompiler;-><init>(Lcom/google/common/base/Platform$1;)V
