...
.method public static final consumeEach(Lkotlinx/coroutines/channels/BroadcastChannel;Lkotlin/jvm/functions/Function1;Lkotlin/coroutines/Continuation;)Ljava/lang/Object;
    ...
    instance-of v1, v0, Lkotlinx/coroutines/channels/ChannelsKt__Channels_commonKt$consumeEach$3;

    if-eqz v1, :cond_0

    move-object v1, v0

    check-cast v1, Lkotlinx/coroutines/channels/ChannelsKt__Channels_commonKt$consumeEach$3;

    iget v2, v1, Lkotlinx/coroutines/channels/ChannelsKt__Channels_commonKt$consumeEach$3;->label:I
    ...
    iget v0, v1, Lkotlinx/coroutines/channels/ChannelsKt__Channels_commonKt$consumeEach$3;->label:I

    sub-int/2addr v0, v3

    iput v0, v1, Lkotlinx/coroutines/channels/ChannelsKt__Channels_commonKt$consumeEach$3;->label:I

    goto :goto_0

    :cond_0
    new-instance v1, Lkotlinx/coroutines/channels/ChannelsKt__Channels_commonKt$consumeEach$3;

    invoke-direct {v1, v0}, Lkotlinx/coroutines/channels/ChannelsKt__Channels_commonKt$consumeEach$3;-><init>(Lkotlin/coroutines/Continuation;)V

    :goto_0
    move-object v0, v1

    .local v1, "$continuation":Lkotlin/coroutines/Continuation;
    iget-object v2, v1, Lkotlinx/coroutines/channels/ChannelsKt__Channels_commonKt$consumeEach$3;->result:Ljava/lang/Object;
    ...
    .line 127
    iget v3, v1, Lkotlinx/coroutines/channels/ChannelsKt__Channels_commonKt$consumeEach$3;->label:I
    ...
    iget-object v10, v1, Lkotlinx/coroutines/channels/ChannelsKt__Channels_commonKt$consumeEach$3;->L$2:Ljava/lang/Object;

    check-cast v10, Lkotlinx/coroutines/channels/ChannelIterator;

    iget-object v11, v1, Lkotlinx/coroutines/channels/ChannelsKt__Channels_commonKt$consumeEach$3;->L$1:Ljava/lang/Object;

    move-object v3, v11

    check-cast v3, Lkotlinx/coroutines/channels/ReceiveChannel;

    iget-object v11, v1, Lkotlinx/coroutines/channels/ChannelsKt__Channels_commonKt$consumeEach$3;->L$0:Ljava/lang/Object;
    ...
    .local v3, "$this$consumeEach":Lkotlinx/coroutines/channels/BroadcastChannel;
    move-object/from16 v8, p1

    .restart local v8    # "action":Lkotlin/jvm/functions/Function1;
    const/4 v9, 0x0
    ...
    .local v6, "$this$consume$iv":Lkotlinx/coroutines/channels/BroadcastChannel;
    const/4 v7, 0x0

    .line 165
    .local v7, "$i$f$consume":I
    invoke-interface {v6}, Lkotlinx/coroutines/channels/BroadcastChannel;->openSubscription()Lkotlinx/coroutines/channels/ReceiveChannel;

    move-result-object v10

    .line 166
    .local v10, "channel$iv":Lkotlinx/coroutines/channels/ReceiveChannel;
    nop

    .line 167
    move-object v11, v10

    .local v11, "$this$consumeEach_u24lambda_u2d4":Lkotlinx/coroutines/channels/ReceiveChannel;
    const/4 v12, 0x0

    .line 129
    .local v12, "$i$a$-consume-ChannelsKt__Channels_commonKt$consumeEach$4":I
    :try_start_1
    ...
    :goto_1
    iput-object v8, v1, Lkotlinx/coroutines/channels/ChannelsKt__Channels_commonKt$consumeEach$3;->L$0:Ljava/lang/Object;

    iput-object v10, v1, Lkotlinx/coroutines/channels/ChannelsKt__Channels_commonKt$consumeEach$3;->L$1:Ljava/lang/Object;

    iput-object v13, v1, Lkotlinx/coroutines/channels/ChannelsKt__Channels_commonKt$consumeEach$3;->L$2:Ljava/lang/Object;

    iput v4, v1, Lkotlinx/coroutines/channels/ChannelsKt__Channels_commonKt$consumeEach$3;->label:I
    ...
    .end local v3    # "$this$consumeEach":Lkotlinx/coroutines/channels/BroadcastChannel;
    .end local v6    # "$this$consume$iv":Lkotlinx/coroutines/channels/BroadcastChannel;
    .end local v11    # "$this$consumeEach_u24lambda_u2d4":Lkotlinx/coroutines/channels/ReceiveChannel;
    if-ne v14, v0, :cond_1
    ...
    .end local v12    # "$i$a$-consume-ChannelsKt__Channels_commonKt$consumeEach$4":I
    .local v6, "$result":Ljava/lang/Object;
    .local v8, "$i$f$consume":I
    .local v9, "action":Lkotlin/jvm/functions/Function1;
    .local v10, "$i$f$consumeEach":I
    .local v11, "channel$iv":Lkotlinx/coroutines/channels/ReceiveChannel;
    .local v13, "$i$a$-consume-ChannelsKt__Channels_commonKt$consumeEach$4":I
    :goto_2
    :try_start_2
    ...
    invoke-interface {v14}, Lkotlinx/coroutines/channels/ChannelIterator;->next()Ljava/lang/Object;
    ...
    .restart local v3    # "$this$consumeEach":Lkotlinx/coroutines/channels/BroadcastChannel;
    move-object v2, v7

    .local v2, "$this$consume$iv":Lkotlinx/coroutines/channels/BroadcastChannel;
    move-object v7, v12
    ...
    .local v7, "$this$consumeEach_u24lambda_u2d4":Lkotlinx/coroutines/channels/ReceiveChannel;
    goto :goto_1

    .line 130
    .end local v2    # "$this$consume$iv":Lkotlinx/coroutines/channels/BroadcastChannel;
    .end local v3    # "$this$consumeEach":Lkotlinx/coroutines/channels/BroadcastChannel;
    .end local v7    # "$this$consumeEach_u24lambda_u2d4":Lkotlinx/coroutines/channels/ReceiveChannel;
    :cond_2
    nop

    .end local v13    # "$i$a$-consume-ChannelsKt__Channels_commonKt$consumeEach$4":I
    ...
    .line 169
    invoke-static {v11, v5, v4, v5}, Lkotlinx/coroutines/channels/ReceiveChannel$DefaultImpls;->cancel$default(Lkotlinx/coroutines/channels/ReceiveChannel;Ljava/util/concurrent/CancellationException;ILjava/lang/Object;)V
    ...
    .end local v11    # "channel$iv":Lkotlinx/coroutines/channels/ReceiveChannel;
    sget-object v0, Lkotlin/Unit;->INSTANCE:Lkotlin/Unit;
    ...
    .restart local v11    # "channel$iv":Lkotlinx/coroutines/channels/ReceiveChannel;
    :catchall_1
    move-exception v0
    ...
    .end local v7    # "$i$f$consume":I
    .end local v10    # "channel$iv":Lkotlinx/coroutines/channels/ReceiveChannel;
    .local v3, "channel$iv":Lkotlinx/coroutines/channels/ReceiveChannel;
    .local v6, "$i$f$consume":I
    :goto_3
    invoke-static {v4}, Lkotlin/jvm/internal/InlineMarker;->finallyStart(I)V
...
.method public static final consumeEach(Lkotlinx/coroutines/channels/ReceiveChannel;Lkotlin/jvm/functions/Function1;Lkotlin/coroutines/Continuation;)Ljava/lang/Object;
    ...
    iget-object v9, p2, Lkotlinx/coroutines/channels/ChannelsKt__Channels_commonKt$consumeEach$1;->L$2:Ljava/lang/Object;

    check-cast v9, Lkotlinx/coroutines/channels/ChannelIterator;

    const/4 v2, 0x0

    iget-object v10, p2, Lkotlinx/coroutines/channels/ChannelsKt__Channels_commonKt$consumeEach$1;->L$1:Ljava/lang/Object;

    move-object v5, v10

    check-cast v5, Lkotlinx/coroutines/channels/ReceiveChannel;

    iget-object v10, p2, Lkotlinx/coroutines/channels/ChannelsKt__Channels_commonKt$consumeEach$1;->L$0:Ljava/lang/Object;
    ...
    .end local v6    # "$i$f$consume":I
    .end local v7    # "$i$a$-consume-ChannelsKt__Channels_commonKt$consumeEach$2":I
    ...
    .local v3, "$this$consumeEach_u24lambda_u2d1":Lkotlinx/coroutines/channels/ReceiveChannel;
    const/4 v7, 0x0

    .line 104
    .restart local v7    # "$i$a$-consume-ChannelsKt__Channels_commonKt$consumeEach$2":I
    :try_start_1
    ...
    :goto_1
    iput-object p1, p2, Lkotlinx/coroutines/channels/ChannelsKt__Channels_commonKt$consumeEach$1;->L$0:Ljava/lang/Object;

    iput-object v5, p2, Lkotlinx/coroutines/channels/ChannelsKt__Channels_commonKt$consumeEach$1;->L$1:Ljava/lang/Object;

    iput-object v9, p2, Lkotlinx/coroutines/channels/ChannelsKt__Channels_commonKt$consumeEach$1;->L$2:Ljava/lang/Object;

    iput v4, p2, Lkotlinx/coroutines/channels/ChannelsKt__Channels_commonKt$consumeEach$1;->label:I

    invoke-interface {v9, p2}, Lkotlinx/coroutines/channels/ChannelIterator;->hasNext(Lkotlin/coroutines/Continuation;)Ljava/lang/Object;

    move-result-object v10
    :try_end_1
    .catchall {:try_start_1 .. :try_end_1} :catchall_1

    .end local v3    # "$this$consumeEach_u24lambda_u2d1":Lkotlinx/coroutines/channels/ReceiveChannel;
    ...
    .local v0, "$this$consumeEach_u24lambda_u2d1":Lkotlinx/coroutines/channels/ReceiveChannel;
    goto :goto_1

    .line 105
    .end local v0    # "$this$consumeEach_u24lambda_u2d1":Lkotlinx/coroutines/channels/ReceiveChannel;
    .end local p0    # "$this$consumeEach":Lkotlinx/coroutines/channels/ReceiveChannel;
    :cond_2
    nop

    .end local v8    # "$i$a$-consume-ChannelsKt__Channels_commonKt$consumeEach$2":I
    ...
    .restart local v0    # "$result":Ljava/lang/Object;
    .restart local v1    # "cause$iv":Ljava/lang/Throwable;
    .restart local v5    # "$this$consume$iv":Lkotlinx/coroutines/channels/ReceiveChannel;
    .restart local v6    # "$i$f$consume":I
    .restart local v8    # "$i$f$consumeEach":I
    .restart local p1    # "action":Lkotlin/jvm/functions/Function1;
...
.method public static final toList(Lkotlinx/coroutines/channels/ReceiveChannel;Lkotlin/coroutines/Continuation;)Ljava/lang/Object;
    ...
    iget-object v11, v1, Lkotlinx/coroutines/channels/ChannelsKt__Channels_commonKt$toList$1;->L$3:Ljava/lang/Object;

    check-cast v11, Lkotlinx/coroutines/channels/ChannelIterator;

    const/4 v3, 0x0

    iget-object v12, v1, Lkotlinx/coroutines/channels/ChannelsKt__Channels_commonKt$toList$1;->L$2:Ljava/lang/Object;

    move-object v5, v12

    check-cast v5, Lkotlinx/coroutines/channels/ReceiveChannel;

    iget-object v12, v1, Lkotlinx/coroutines/channels/ChannelsKt__Channels_commonKt$toList$1;->L$1:Ljava/lang/Object;

    move-object v10, v12

    check-cast v10, Ljava/util/List;

    iget-object v12, v1, Lkotlinx/coroutines/channels/ChannelsKt__Channels_commonKt$toList$1;->L$0:Ljava/lang/Object;
    ...
    .local v13, "$this$consumeEach_u24lambda_u2d1$iv":Lkotlinx/coroutines/channels/ReceiveChannel;
    const/4 v14, 0x0
    ...
    .end local v13    # "$this$consumeEach_u24lambda_u2d1$iv":Lkotlinx/coroutines/channels/ReceiveChannel;
    .local v4, "$this$consumeEach_u24lambda_u2d1$iv":Lkotlinx/coroutines/channels/ReceiveChannel;
    .local v5, "$this$consume$iv$iv":Lkotlinx/coroutines/channels/ReceiveChannel;
    .local v7, "$i$f$consume":I
    :goto_1
    :try_start_2
    iput-object v13, v1, Lkotlinx/coroutines/channels/ChannelsKt__Channels_commonKt$toList$1;->L$0:Ljava/lang/Object;

    iput-object v10, v1, Lkotlinx/coroutines/channels/ChannelsKt__Channels_commonKt$toList$1;->L$1:Ljava/lang/Object;

    iput-object v5, v1, Lkotlinx/coroutines/channels/ChannelsKt__Channels_commonKt$toList$1;->L$2:Ljava/lang/Object;

    iput-object v11, v1, Lkotlinx/coroutines/channels/ChannelsKt__Channels_commonKt$toList$1;->L$3:Ljava/lang/Object;

    const/4 v15, 0x1

    iput v15, v1, Lkotlinx/coroutines/channels/ChannelsKt__Channels_commonKt$toList$1;->label:I
    ...
    .end local v3    # "$this$toList":Lkotlinx/coroutines/channels/ReceiveChannel;
    .end local v4    # "$this$consumeEach_u24lambda_u2d1$iv":Lkotlinx/coroutines/channels/ReceiveChannel;
    ...
    .local v7, "$this$consume$iv$iv":Lkotlinx/coroutines/channels/ReceiveChannel;
    .local v8, "$i$f$consume":I
    .local v9, "$i$a$-buildList-ChannelsKt__Channels_commonKt$toList$2":I
    .local v10, "$i$f$consumeEach":I
    .local v11, "$this$toList_u24lambda_u2d3":Ljava/util/List;
    .local v13, "cause$iv$iv":Ljava/lang/Throwable;
    .local v15, "$i$a$-consume-ChannelsKt__Channels_commonKt$consumeEach$2$iv":I
    :goto_2
    :try_start_3
    check-cast v2, Ljava/lang/Boolean;
    ...
    .restart local v3    # "$this$toList":Lkotlinx/coroutines/channels/ReceiveChannel;
    move-object v0, v5

    .local v0, "$this$consumeEach_u24lambda_u2d1$iv":Lkotlinx/coroutines/channels/ReceiveChannel;
    move-object v2, v4
    ...
    .line 160
    .end local v0    # "$this$consumeEach_u24lambda_u2d1$iv":Lkotlinx/coroutines/channels/ReceiveChannel;
    .end local v3    # "$this$toList":Lkotlinx/coroutines/channels/ReceiveChannel;
    .end local v6    # "$this$consumeEach$iv":Lkotlinx/coroutines/channels/ReceiveChannel;
    :cond_2
    nop

    .end local v15    # "$i$a$-consume-ChannelsKt__Channels_commonKt$consumeEach$2$iv":I
    sget-object v0, Lkotlin/Unit;->INSTANCE:Lkotlin/Unit;
    :try_end_3
    .catchall {:try_start_3 .. :try_end_3} :catchall_1

    .line 161
    invoke-static {v7, v13}, Lkotlinx/coroutines/channels/ChannelsKt;->cancelConsumed(Lkotlinx/coroutines/channels/ReceiveChannel;Ljava/lang/Throwable;)V
    ...
    .line 114
    .end local v9    # "$i$a$-buildList-ChannelsKt__Channels_commonKt$toList$2":I
    ...
    .restart local v8    # "$i$f$consume":I
    .restart local v9    # "$i$a$-buildList-ChannelsKt__Channels_commonKt$toList$2":I
