...
.method public collect(Lkotlinx/coroutines/flow/FlowCollector;Lkotlin/coroutines/Continuation;)Ljava/lang/Object;
    ...
    .local v2, "$this$take_u24lambda_u2d7":Lkotlinx/coroutines/flow/FlowCollector;
    const/4 p1, 0x0

    const/4 v1, 0x0

    iget-object v3, p2, Lkotlinx/coroutines/flow/FlowKt__LimitKt$take$$inlined$unsafeFlow$1$1;->L$0:Ljava/lang/Object;
    ...
    .line 105
    .end local v2    # "$this$take_u24lambda_u2d7":Lkotlinx/coroutines/flow/FlowCollector;
    ...
    .local v4, "$this$take_u24lambda_u2d7":Lkotlinx/coroutines/flow/FlowCollector;
    const/4 v5, 0x0
    ...
    .line 115
    :try_start_1
    iget-object v7, v2, Lkotlinx/coroutines/flow/FlowKt__LimitKt$take$$inlined$unsafeFlow$1;->$this_take$inlined:Lkotlinx/coroutines/flow/Flow;
    ...
    new-instance v9, Lkotlinx/coroutines/flow/FlowKt__LimitKt$take$lambda-7$$inlined$collect$1;

    iget v10, v2, Lkotlinx/coroutines/flow/FlowKt__LimitKt$take$$inlined$unsafeFlow$1;->$count$inlined:I

    invoke-direct {v9, v6, v10, v4}, Lkotlinx/coroutines/flow/FlowKt__LimitKt$take$lambda-7$$inlined$collect$1;-><init>(Lkotlin/jvm/internal/Ref$IntRef;ILkotlinx/coroutines/flow/FlowCollector;)V

    check-cast v9, Lkotlinx/coroutines/flow/FlowCollector;

    iput-object v4, p2, Lkotlinx/coroutines/flow/FlowKt__LimitKt$take$$inlined$unsafeFlow$1$1;->L$0:Ljava/lang/Object;

    const/4 v10, 0x1

    iput v10, p2, Lkotlinx/coroutines/flow/FlowKt__LimitKt$take$$inlined$unsafeFlow$1$1;->label:I

    invoke-interface {v7, v9, v8}, Lkotlinx/coroutines/flow/Flow;->collect(Lkotlinx/coroutines/flow/FlowCollector;Lkotlin/coroutines/Continuation;)Ljava/lang/Object;
    ...
    .end local v4    # "$this$take_u24lambda_u2d7":Lkotlinx/coroutines/flow/FlowCollector;
    ...
    .end local v2    # "$this$take_u24lambda_u2d7":Lkotlinx/coroutines/flow/FlowCollector;
    .end local p1    # "$i$a$-unsafeFlow-FlowKt__LimitKt$take$2":I
    .restart local v4    # "$this$take_u24lambda_u2d7":Lkotlinx/coroutines/flow/FlowCollector;
    .restart local v5    # "$i$a$-unsafeFlow-FlowKt__LimitKt$take$2":I
    :catch_1
    move-exception v1
    ...
    .restart local v2    # "$this$take_u24lambda_u2d7":Lkotlinx/coroutines/flow/FlowCollector;
