...
.method public collect(Lkotlinx/coroutines/flow/FlowCollector;Lkotlin/coroutines/Continuation;)Ljava/lang/Object;
    ...
    .local p1, "collector$iv":Lkotlinx/coroutines/flow/FlowKt__LimitKt$takeWhile$lambda-9$$inlined$collectWhile$1;
    const/4 v1, 0x0

    move v2, v1

    .local v1, "$i$f$collectWhile":I
    .local v2, "$i$a$-unsafeFlow-FlowKt__LimitKt$takeWhile$1":I
    const/4 v2, 0x0

    const/4 v1, 0x0

    iget-object v3, p2, Lkotlinx/coroutines/flow/FlowKt__LimitKt$takeWhile$$inlined$unsafeFlow$1$1;->L$0:Ljava/lang/Object;
    ...
    .end local v2    # "$i$a$-unsafeFlow-FlowKt__LimitKt$takeWhile$1":I
    .end local p1    # "collector$iv":Lkotlinx/coroutines/flow/FlowKt__LimitKt$takeWhile$lambda-9$$inlined$collectWhile$1;
    :pswitch_1
    invoke-static {v0}, Lkotlin/ResultKt;->throwOnFailure(Ljava/lang/Object;)V
    ...
    .local v4, "$this$takeWhile_u24lambda_u2d9":Lkotlinx/coroutines/flow/FlowCollector;
    const/4 v5, 0x0

    .line 113
    .local v5, "$i$a$-unsafeFlow-FlowKt__LimitKt$takeWhile$1":I
    iget-object v6, v2, Lkotlinx/coroutines/flow/FlowKt__LimitKt$takeWhile$$inlined$unsafeFlow$1;->$this_takeWhile$inlined:Lkotlinx/coroutines/flow/Flow;
    ...
    new-instance v9, Lkotlinx/coroutines/flow/FlowKt__LimitKt$takeWhile$lambda-9$$inlined$collectWhile$1;

    iget-object v10, v2, Lkotlinx/coroutines/flow/FlowKt__LimitKt$takeWhile$$inlined$unsafeFlow$1;->$predicate$inlined:Lkotlin/jvm/functions/Function2;

    invoke-direct {v9, v10, v4}, Lkotlinx/coroutines/flow/FlowKt__LimitKt$takeWhile$lambda-9$$inlined$collectWhile$1;-><init>(Lkotlin/jvm/functions/Function2;Lkotlinx/coroutines/flow/FlowCollector;)V

    .line 123
    .local v9, "collector$iv":Lkotlinx/coroutines/flow/FlowKt__LimitKt$takeWhile$lambda-9$$inlined$collectWhile$1;
    nop
    ...
    iput-object v9, p2, Lkotlinx/coroutines/flow/FlowKt__LimitKt$takeWhile$$inlined$unsafeFlow$1$1;->L$0:Ljava/lang/Object;

    const/4 v10, 0x1

    iput v10, p2, Lkotlinx/coroutines/flow/FlowKt__LimitKt$takeWhile$$inlined$unsafeFlow$1$1;->label:I

    invoke-interface {v6, v3, v7}, Lkotlinx/coroutines/flow/Flow;->collect(Lkotlinx/coroutines/flow/FlowCollector;Lkotlin/coroutines/Continuation;)Ljava/lang/Object;
    ...
    .end local v4    # "$this$takeWhile_u24lambda_u2d9":Lkotlinx/coroutines/flow/FlowCollector;
    ...
    .end local v8    # "$i$f$collectWhile":I
    .end local v9    # "collector$iv":Lkotlinx/coroutines/flow/FlowKt__LimitKt$takeWhile$lambda-9$$inlined$collectWhile$1;
    ...
    .end local v2    # "$i$a$-unsafeFlow-FlowKt__LimitKt$takeWhile$1":I
    .end local p1    # "collector$iv":Lkotlinx/coroutines/flow/FlowKt__LimitKt$takeWhile$lambda-9$$inlined$collectWhile$1;
    .restart local v5    # "$i$a$-unsafeFlow-FlowKt__LimitKt$takeWhile$1":I
    .restart local v8    # "$i$f$collectWhile":I
    .restart local v9    # "collector$iv":Lkotlinx/coroutines/flow/FlowKt__LimitKt$takeWhile$lambda-9$$inlined$collectWhile$1;
    :catch_1
    move-exception v3
    ...
    .end local v9    # "collector$iv":Lkotlinx/coroutines/flow/FlowKt__LimitKt$takeWhile$lambda-9$$inlined$collectWhile$1;
    .restart local v1    # "$i$f$collectWhile":I
    .restart local v2    # "$i$a$-unsafeFlow-FlowKt__LimitKt$takeWhile$1":I
    .local v3, "e$iv":Lkotlinx/coroutines/flow/internal/AbortFlowException;
    .restart local p1    # "collector$iv":Lkotlinx/coroutines/flow/FlowKt__LimitKt$takeWhile$lambda-9$$inlined$collectWhile$1;
    :goto_2
    move-object v4, p1
