...
.method public final invokeSuspend(Ljava/lang/Object;)Ljava/lang/Object;
    ...
    .line 242
    .local v3, "$this$onFailure$iv":Ljava/lang/Object;
    iget-object v4, v1, Lkotlinx/coroutines/flow/FlowKt__DelayKt$debounceInternal$1$3$2;->$lastValue:Lkotlin/jvm/internal/Ref$ObjectRef;

    iget-object v5, v1, Lkotlinx/coroutines/flow/FlowKt__DelayKt$debounceInternal$1$3$2;->$downstream:Lkotlinx/coroutines/flow/FlowCollector;

    const/4 v6, 0x0

    .line 358
    .local v6, "$i$f$onFailure-WpGqRn0":I
    nop

    .line 362
    instance-of v7, v3, Lkotlinx/coroutines/channels/ChannelResult$Failed;
    ...
    .line 243
    .local v8, "$i$a$-onFailure-WpGqRn0-FlowKt__DelayKt$debounceInternal$1$3$2$2":I
    if-nez v7, :cond_4
    ...
    .end local v11    # "$i$f$unbox":I
    :cond_1
    iput-object v3, v1, Lkotlinx/coroutines/flow/FlowKt__DelayKt$debounceInternal$1$3$2;->L$0:Ljava/lang/Object;

    iput-object v4, v1, Lkotlinx/coroutines/flow/FlowKt__DelayKt$debounceInternal$1$3$2;->L$1:Ljava/lang/Object;

    const/4 v9, 0x1

    iput v9, v1, Lkotlinx/coroutines/flow/FlowKt__DelayKt$debounceInternal$1$3$2;->label:I

    invoke-interface {v5, v10, v1}, Lkotlinx/coroutines/flow/FlowCollector;->emit(Ljava/lang/Object;Lkotlin/coroutines/Continuation;)Ljava/lang/Object;

    move-result-object v2

    .end local v2    # "value":Ljava/lang/Object;
    .end local v3    # "$this$onFailure$iv":Ljava/lang/Object;
    ...
    .line 246
    .end local v6    # "$i$f$onFailure-WpGqRn0":I
    .end local v8    # "$i$a$-onFailure-WpGqRn0-FlowKt__DelayKt$debounceInternal$1$3$2$2":I
    ...
    .end local v2    # "$i$f$onFailure-WpGqRn0":I
    .local v1, "this":Lkotlinx/coroutines/flow/FlowKt__DelayKt$debounceInternal$1$3$2;
    .restart local v6    # "$i$f$onFailure-WpGqRn0":I
    .restart local v8    # "$i$a$-onFailure-WpGqRn0-FlowKt__DelayKt$debounceInternal$1$3$2$2":I
    :cond_3
    ...
    .line 243
    .local v2, "value":Ljava/lang/Object;
    .restart local v3    # "$this$onFailure$iv":Ljava/lang/Object;
    .restart local v7    # "it":Ljava/lang/Throwable;
    :cond_4
    move-object v0, v7
    ...
    .line 243
    .local v4, "$i$a$-let-FlowKt__DelayKt$debounceInternal$1$3$2$2$1":I
    throw v0
    ...
    .end local v2    # "value":Ljava/lang/Object;
    .end local v3    # "$this$onFailure$iv":Ljava/lang/Object;
    .end local v4    # "$i$a$-let-FlowKt__DelayKt$debounceInternal$1$3$2$2$1":I
    .end local v7    # "it":Ljava/lang/Throwable;
    .end local v8    # "$i$a$-onFailure-WpGqRn0-FlowKt__DelayKt$debounceInternal$1$3$2$2":I
    :cond_5
    :goto_1
